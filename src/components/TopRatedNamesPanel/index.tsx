  ...
  return (
    ...
    >
      ...
      <p className="list-block-hint">
        Оценки понравившихся имён, сначала самые высокие.
        «Сброс» возвращает оценку к 0 и убирает имя из этого списка.
      </p>
      {entries.length === 0 ? (
        <p className="list-empty">Пока нет понравившихся имён.</p>
      ) : (
        <>
          <ul
            className="name-list"
